...
import { AnalysisGroup, AnalysisGroupPredictorVariable, AnalysisTableColumns, AnnualAnalysisSummary, JStatRegressionModel, MonthlyAnalysisSummaryData } from '@app/models/analysis';
