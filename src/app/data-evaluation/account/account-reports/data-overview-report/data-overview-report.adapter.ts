...
export class DataOverviewReportAdapter {
        ...
        if (this.reportSettings.includeAccountReport) {
            ...
            if (!this.accountData.calculationError) {
                if (this.reportSettings.includeEnergySection) {
                    ...
                    sections.push(...this.buildSection('energyUse'));
                }
                if (this.reportSettings.includeWaterSection) {
                    ...
                    sections.push(headingSection);
                    sections.push(...this.buildSection('water'));
                }
                if (this.reportSettings.includeCostsSection) {
                    ...
                    sections.push(headingSection);
                    sections.push(...this.buildSection('cost'));
                }
            }
        }
    ...
    private buildSection(type: 'energyUse' | 'cost' | 'water') {
        ...
        if (this.reportSettings.includeFacilityTable) {
            let tableSection = this.buildFacilityTableSection(type);
            if (tableSection) {
        ...
        if (this.reportSettings.includeFacilityTable) {
            ...
            tableSection = this.buildUtilityTableSection(type);
            if (tableSection) {
                tableSection.pageBreakAfter = true;
                sections.push(tableSection);
            }
        ...
        if (this.reportSettings.includeUtilityTable) {
            let tableSection = this.buildUtilityConsumptionTableSection(type);
            if (tableSection) {
                tableSection.pageBreakAfter = true;
                sections.push(tableSection);
            }
    ...
    private buildFacilityTableSection(type: 'energyUse' | 'cost' | 'water'): TableSection | undefined {
        let headers: string[] = [];
        let rows: string[][] = [];
    ...
    private buildUtilityTableSection(type: 'energyUse' | 'cost' | 'water'): TableSection | undefined {
        let headers: string[] = [];
        let rows: string[][] = [];
    ...
    private buildUtilityConsumptionTableSection(type: 'energyUse' | 'cost' | 'water'): TableSection | undefined {
