...
import { CarbonReportDashboardComponent } from "../account/account-reports/account-reports-dashboard/carbon-report-dashboard/carbon-report-dashboard.component";
import { CarbonReportComponent } from "../account/account-reports/carbon-report/carbon-report.component";
            ...
            children: [
                { path: '', pathMatch: 'full', redirectTo: 'dashboard' },
                {
                    ...
                    children: [
                        ...
                        { path: 'carbon', component: CarbonReportDashboardComponent }
                    ]
                },
                ...
                { path: 'carbon-report', component: CarbonReportComponent }
            ]
        },
        {
            path: 'analysis',
