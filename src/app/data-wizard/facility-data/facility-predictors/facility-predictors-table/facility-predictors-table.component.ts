...
export class FacilityPredictorsTableComponent {
  ...
  predictorEntriesSub: Subscription;
  ...
  ngOnInit() {
    this.predictorEntriesSub = this.predictorDbService.facilityPredictorEntries.subscribe(val => {
      this.predictorEntries = val;
    });
  ...
  ngOnDestroy() {
    ...
    this.predictorEntriesSub.unsubscribe();
  }
