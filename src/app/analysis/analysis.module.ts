...
import { MonthlyRegressionAnalysisTableComponent } from './run-analysis/group-analysis/regression/monthly-regression-analysis/monthly-regression-analysis-table/monthly-regression-analysis-table.component';
