...
@Component({
  selector: 'app-p1-account-home-goal-progress-page',
  templateUrl: './account-home-goal-progress-page.component.html',
  styleUrls: [
...
export class P1AccountHomeGoalProgressPageComponent {
