...
import { AccountAnalysisListComponent } from "src/app/data-evaluation/facility/analysis/account-analysis-list/account-analysis-list.component";
import { AnalysisDashboardComponent } from "src/app/data-evaluation/facility/analysis/analysis-dashboard/analysis-dashboard.component";
import { AnalysisComponent } from "src/app/data-evaluation/facility/analysis/analysis.component";
import { AnalysisSetupComponent } from "src/app/data-evaluation/facility/analysis/run-analysis/analysis-setup/analysis-setup.component";
import { AnnualFacilityAnalysisComponent } from "src/app/data-evaluation/facility/analysis/run-analysis/facility-analysis/annual-facility-analysis/annual-facility-analysis.component";
import { FacilityAnalysisComponent } from "src/app/data-evaluation/facility/analysis/run-analysis/facility-analysis/facility-analysis.component";
import { MonthlyFacilityAnalysisComponent } from "src/app/data-evaluation/facility/analysis/run-analysis/facility-analysis/monthly-facility-analysis/monthly-facility-analysis.component";
import { AnnualAnalysisSummaryComponent } from "src/app/data-evaluation/facility/analysis/run-analysis/group-analysis/annual-analysis-summary/annual-analysis-summary.component";
import { GroupAnalysisOptionsComponent } from "src/app/data-evaluation/facility/analysis/run-analysis/group-analysis/group-analysis-options/group-analysis-options.component";
import { GroupAnalysisComponent } from "src/app/data-evaluation/facility/analysis/run-analysis/group-analysis/group-analysis.component";
import { MonthlyAnalysisSummaryComponent } from "src/app/data-evaluation/facility/analysis/run-analysis/group-analysis/monthly-analysis-summary/monthly-analysis-summary.component";
import { RegressionModelSelectionComponent } from "src/app/data-evaluation/facility/analysis/run-analysis/group-analysis/regression-model-selection/regression-model-selection.component";
import { RunAnalysisComponent } from "src/app/data-evaluation/facility/analysis/run-analysis/run-analysis.component";
import { FacilityHomeComponent } from "src/app/data-evaluation/facility/facility-home/facility-home.component";
import { FacilityCostOverviewComponent } from "src/app/data-evaluation/facility/facility-overview/facility-cost-overview/facility-cost-overview.component";
import { FacilityEmissionsOverviewComponent } from "src/app/data-evaluation/facility/facility-overview/facility-emissions-overview/facility-emissions-overview.component";
import { FacilityEnergyOverviewComponent } from "src/app/data-evaluation/facility/facility-overview/facility-energy-overview/facility-energy-overview.component";
import { FacilityOverviewComponent } from "src/app/data-evaluation/facility/facility-overview/facility-overview.component";
import { FacilityWaterOverviewComponent } from "src/app/data-evaluation/facility/facility-overview/facility-water-overview/facility-water-overview.component";
import { FacilitySettingsComponent } from "src/app/data-evaluation/facility/facility-settings/facility-settings.component";
import { FacilityComponent } from "src/app/data-evaluation/facility/facility.component";
import { CalanderizationComponent } from "src/app/data-evaluation/facility/utility-data/calanderization/calanderization.component";
import { EnergyConsumptionComponent } from "src/app/data-evaluation/facility/utility-data/energy-consumption/energy-consumption.component";
import { EnergySourceComponent } from "src/app/data-evaluation/facility/utility-data/energy-consumption/energy-source/energy-source.component";
...
import { UtilityMeterDataComponent } from "src/app/data-evaluation/facility/utility-data/energy-consumption/utility-meter-data/utility-meter-data.component";
import { MeterGroupingComponent } from "src/app/data-evaluation/facility/utility-data/meter-grouping/meter-grouping.component";
import { UtilityDataComponent } from "src/app/data-evaluation/facility/utility-data/utility-data.component";
import { CorrelationHeatmapComponent } from "src/app/data-evaluation/facility/visualization/correlation-heatmap/correlation-heatmap.component";
import { CorrelationPlotMenuComponent } from "src/app/data-evaluation/facility/visualization/correlation-plot-menu/correlation-plot-menu.component";
import { CorrelationPlotComponent } from "src/app/data-evaluation/facility/visualization/correlation-plot/correlation-plot.component";
...
import { PredictorsDataComponent } from "src/app/data-evaluation/facility/utility-data/predictors/predictors-data/predictors-data.component";
...
import { PredictorsDataFormComponent } from "src/app/data-evaluation/facility/utility-data/predictors/predictors-data/predictors-data-form/predictors-data-form.component";
...
import { FacilityReportsComponent } from "src/app/data-evaluation/facility/facility-reports/facility-reports.component";
import { FacilityReportsDashboardComponent } from "src/app/data-evaluation/facility/facility-reports/facility-reports-dashboard/facility-reports-dashboard.component";
import { FacilityReportSetupComponent } from "src/app/data-evaluation/facility/facility-reports/facility-report-setup/facility-report-setup.component";
