...
export class AnalysisDetailItemCardComponent implements OnInit {
  @Input()
  ...
  get regressionGroupItems() {
    return this.groupItems.filter(item => item.group.analysisType === 'regression' && !item.group.groupErrors.hasErrors);
  }
