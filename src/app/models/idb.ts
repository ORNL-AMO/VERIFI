...
import { BetterPlantsReportSetup, CarbonReportSetup, DataOverviewReportSetup, PerformanceReportSetup } from './overview-report';
...
export interface IdbAccountReport {
    ...
    carbonReportSetup: CarbonReportSetup
}
