  ...
  drawChart() { 
    ...
    if (this.rollingEnergyConsumptionGraph) {
      ...
      var trace1 = {
        ...
        y: monthlySummaryData.map(results => { return results.rollingActual }),
      ...
      var trace2 = {
        x: monthlySummaryData.map(results => { return results.date }),
        y: monthlySummaryData.map(results => { return results.fifteenPercentTarget }),
        fillcolor: '#8e9f88',
        fill: 'tozeroy',
        line: { width: 0 },
        mode: 'lines',
      ...
      var trace3 = {
        x: monthlySummaryData.map(results => { return results.date }),
        y: monthlySummaryData.map(results => { return results.tenPercentTarget }),
        fillcolor: '#9cb491',
        fill: 'tonexty',
        line: { width: 0 },
        mode: 'lines',
      ...
      var trace4 = {
        x: monthlySummaryData.map(results => { return results.date }),
        y: monthlySummaryData.map(results => { return results.fivePercentTarget }),
        fillcolor: '#d5e3d0',
        fill: 'tonexty',
        line: { width: 0 },
        mode: 'lines',
