...
export class OverviewReportMenuComponent implements OnInit {
  ...
  async createReport() {
    ...
    this.toastNotificationsService.showToast('New Report Created', undefined, 4000, false, "alert-success");
  ...
  async updateReport() {
    ...
    await this.dbChangesService.setAccountOverviewReportOptions(selectedAccount);
    this.overviewReportService.reportOptions.next(this.reportOptions);
    this.toastNotificationsService.showToast('Report Updated', undefined, 4000, false, "alert-success");
    this.router.navigateByUrl('/account/reports/basic-report');
  }
  ...
  async saveTemplate() {
    ...
    this.overviewReportService.reportOptions.next(this.reportOptions);
    this.toastNotificationsService.showToast('Template Configuration Saved', undefined, 4000, false, "alert-success");
