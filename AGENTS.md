...
- Put each Angular component in its own folder with its template, styles, and spec beside the component class. Do not place multiple child component file sets side by side in a parent feature folder.
