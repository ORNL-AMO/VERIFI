...
1. Read [`AGENTS.md`](../../../AGENTS.md), the calculation/Worker section of [`ARCHITECTURE.md`](../../../ARCHITECTURE.md), and the Implementer and Reviewer modes in [`docs/agents/personas.md`](../../../docs/agents/personas.md).
