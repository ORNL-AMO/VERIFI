...
export class WeatherDataComponent {
  ...
  async confirmCreate() {
    //TODO: Update method for weather data creation.
    // this.analyticsService.sendEvent('weather_data_predictors');
    // this.weatherDataService.applyToFacility.next(false);
    // this.loadingService.setLoadingMessage('Updating Predictors...');
    // this.loadingService.setLoadingStatus(true);
    // let facilityPredictors: Array<IdbPredictor> = this.predictorDbService.getByFacilityId(this.selectedFacility.guid);
