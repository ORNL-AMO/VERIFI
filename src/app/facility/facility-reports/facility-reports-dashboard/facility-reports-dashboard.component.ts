...
export class FacilityReportsDashboardComponent {
  ...
  reportType: 'Analysis' | 'Data Overview' | 'SEP';
  ...
  async createReport() {
    ...
    let newReport: IdbFacilityReport = getNewIdbFacilityReport(this.selectedFacility, this.newReportType, groups);
